...
@SpringBootTest
@Log4j2
public class StudentCourserRepositoryTests {
    ...
    @Test
    @Transactional
    public void testGetCourseListByUserNo() {

        List<Object[]> resultList = studentCourseRepository.getCourseListByUserNo(9L).orElseThrow();
        ...
        courseDTOList.forEach(course -> {
            log.info("캠퍼스명 : " + course.getCampusName());
